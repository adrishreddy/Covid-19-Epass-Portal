...
<head>
    ...
    rel="stylesheet">
    <link rel="stylesheet" href="/css/emergencyRegistrationFromTelengana.css">
</head>
<body>
    ...
    <h1 style="text-align: center;">Emergency Registration for pass to other states</h1>
    <br>
    <div class="container">
        <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
                ...
                <div>
                    <form action="/success6" method="POST">
                ...
                <script src="/js/emergencyRegistrationFromTelengana.js"></script>
                </div> 
            </div>
        </div>
