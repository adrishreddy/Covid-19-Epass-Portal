...
<head>
    ...
    <title>Online Registration for pass to other states</title>
    ...
    rel="stylesheet">
    <link rel="stylesheet" href="/css/onlineRegistrationFromTelangana.css">
</head>
<body>
    ...
    <h1 style="text-align: center;">Online Registration for pass to other states</h1>
    <br>
    <div class="container">
        <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
                ...
                <div>
                    <form action="/success3" method="post">
                ...
                <script src="/js/onlineRegistrationFromTelangana.js"></script>
                </div> 
            </div>
        </div>
