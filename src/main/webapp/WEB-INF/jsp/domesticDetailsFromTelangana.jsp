...
<head>
    ...
    <title>Domestic Passanger Enrollment to other states</title>
    ...
    rel="stylesheet">
    <link rel="stylesheet" href="/css/domesticDetailsFromTelangana.css">
</head>
<body>
    ...
    <h1 style="text-align: center;">Domestic Passanger Enrollment to other states</h1>
    <br>
    <div class="container">
                    ...
                    <form action="/success1" method="post">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="arrival_border" name="arrivalBorder" required>
                                        <option value="">Select</option>
                                        <option value="1">Rajiv Gandhi International Airport</option>
                                        <option value="2">Begumpet Airport</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="state" value="Telangana" name="state" disabled>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="margin: 0; text-align: center;">
                                <button type="submit"  id="l"  class="btn btn-success">Submit my Application</button>   
                            </div>
                        </div>
                    </form> 
                <script src="/js/domesticDetailsFromTelangana.js"></script>
                </div> 
            </div>
        </div>
