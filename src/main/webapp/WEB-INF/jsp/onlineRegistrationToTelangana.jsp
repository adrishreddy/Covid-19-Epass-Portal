...
<head>
    ...
    <title>Online Registration for pass to Telangana</title>
    ...
    rel="stylesheet">
    <link rel="stylesheet" href="/css/onlineRegistrationToTelangana.css">
</head>
<body>
    ...
    <h1 style="text-align: center;">Online Registration for pass to Telangana</h1>
    <br>
    <div class="container">
        <div class="card shadow p-3 mb-5 bg-white rounded">
            <div class="card-body">
                ...
                <div>
                    <form action="/success4" method="post">
                ...
                <script src="/js/onlineRegistrationToTelangana.js"></script>
                </div> 
            </div>
        </div>
