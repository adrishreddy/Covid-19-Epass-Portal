...
@Controller
public class EmergencyRegistrationToTelanganaController {

	@Autowired
	private HealthToService service;
	
	@RequestMapping(value="/success7",method=RequestMethod.POST)
	...
	private String generateAid() {
	    ...
	    String temp = "HT"+days[2]+days[1]+id;  
